...
These guides will be added in future phases:

- **Deploy lumehaven** — Docker setup, production configuration, reverse proxy
- **Develop Frontend Widgets** — Create new dashboard widgets (Phase 3+)
- **Generate Custom Dashboards** — Build and configure dashboard layouts
