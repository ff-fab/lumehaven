...
- [Test Design Techniques](01-test-design-techniques.md) — Full technique reference
- [Test Organization](04-test-organization.md) — Directory structure, naming
- [Tooling Configuration](05-tooling-configuration.md) — pytest settings, coverage
